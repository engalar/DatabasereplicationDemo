...
public class UpdateByMapping_UsingUpdateSet extends CustomJavaAction<java.lang.Boolean>
{
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		this.UpdateSetObject = this.__UpdateSetObject == null ? null : databasereplication.proxies.UpdateSet.initialize(getContext(), __UpdateSetObject);

		this.UpdateConfig = this.__UpdateConfig == null ? null : databasereplication.proxies.UpdateConfiguration.initialize(getContext(), __UpdateConfig);
